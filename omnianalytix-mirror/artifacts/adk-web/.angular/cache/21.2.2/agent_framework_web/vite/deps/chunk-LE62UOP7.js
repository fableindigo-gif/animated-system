...
// node_modules/@a2ui/angular/fesm2022/a2ui-angular.mjs
function Row_For_2_Template(rf, ctx) {
  if (rf & 1) {
...
function Column_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0, 0);
  }
  if (rf & 2) {
...
function Surface_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0, 0);
  }
  if (rf & 2) {
    ɵɵnextContext();
    const surfaceId_r1 = ɵɵreadContextLet(0);
    const surface_r2 = ɵɵreadContextLet(1);
    ɵɵproperty("surfaceId", surfaceId_r1)("component", surface_r2.componentTree);
  }
}
var Catalog = new InjectionToken("Catalog");
var MessageProcessor = class _MessageProcessor extends Data.A2uiMessageProcessor {
  events = new Subject();
  setData(node, relativePath, value, surfaceId) {
    return super.setData(node, relativePath, value, surfaceId ?? void 0);
  }
  dispatch(message) {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    let ɵMessageProcessor_BaseFactory;
    return function MessageProcessor_Factory(__ngFactoryType__) {
      return (ɵMessageProcessor_BaseFactory || (ɵMessageProcessor_BaseFactory = ɵɵgetInheritedFactory(_MessageProcessor)))(__ngFactoryType__ || _MessageProcessor);
    };
  })();
  static ɵprov = ɵɵdefineInjectable({
    token: _MessageProcessor,
    factory: _MessageProcessor.ɵfac,
    providedIn: "root"
  });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MessageProcessor, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
var DynamicComponent = class _DynamicComponent {
  ...
  theme = inject(Theme);
  surfaceId = input.required(...ngDevMode ? [{
    debugName: "surfaceId"
  }] : []);
  component = input.required(...ngDevMode ? [{
    debugName: "component"
  }] : []);
  weight = input.required(...ngDevMode ? [{
    debugName: "weight"
  }] : []);
  sendAction(action) {
    const component = this.component();
    const surfaceId = this.surfaceId() ?? void 0;
    const context = {};
    if (action.context) {
  ...
  resolvePrimitive(value) {
    ...
    if (!value || typeof value !== "object") {
      ...
      return this.processor.getData(component, value.path, surfaceId ?? void 0);
  ...
  static ɵfac = function DynamicComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DynamicComponent)();
  };
  static ɵdir = ɵɵdefineDirective({
    type: _DynamicComponent,
    hostVars: 2,
    hostBindings: function DynamicComponent_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵstyleProp("--weight", ctx.weight());
      }
    },
    inputs: {
...
var Renderer2 = class _Renderer {
  ...
  constructor() {
    ...
    if (!_Renderer.hasInsertedStyles && isPlatformBrowser(platformId)) {
      const styles = document2.createElement("style");
      styles.textContent = styles_exports.structuralStyles;
      document2.head.appendChild(styles);
      _Renderer.hasInsertedStyles = true;
    }
  }
  ngOnDestroy() {
  ...
  render(surfaceId, component) {
    return __async(this, null, function* () {
      const config2 = this.catalog[component.type];
      let newComponent = null;
      let componentBindings = null;
      if (typeof config2 === "function") {
        newComponent = yield config2();
      } else if (typeof config2 === "object") {
        newComponent = yield config2.type();
        componentBindings = config2.bindings(component);
      }
      this.clear();
      if (newComponent && !this.isDestroyed) {
        const bindings = [inputBinding("surfaceId", () => surfaceId), inputBinding("component", () => component), inputBinding("weight", () => component.weight ?? "initial")];
  ...
  static ɵfac = function Renderer_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Renderer)();
  };
  static ɵdir = ɵɵdefineDirective({
    type: _Renderer,
    selectors: [["ng-container", "a2ui-renderer", ""]],
    inputs: {
      surfaceId: [1, "surfaceId"],
      component: [1, "component"]
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Renderer2, [{
    type: Directive,
    args: [{
...
function provideA2UI(config2) {
  return makeEnvironmentProviders([{
    provide: Catalog,
    useValue: config2.catalog
  }, {
    provide: Theme,
    useValue: config2.theme
  }]);
}
var Row = class _Row extends DynamicComponent {
  alignment = input("stretch", ...ngDevMode ? [{
    debugName: "alignment"
  }] : []);
  distribution = input("start", ...ngDevMode ? [{
    debugName: "distribution"
  }] : []);
  classes = computed(() => __spreadProps(__spreadValues({}, this.theme.components.Row), {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    let ɵRow_BaseFactory;
    return function Row_Factory(__ngFactoryType__) {
      return (ɵRow_BaseFactory || (ɵRow_BaseFactory = ɵɵgetInheritedFactory(_Row)))(__ngFactoryType__ || _Row);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    ...
    selectors: [["a2ui-row"]],
    hostVars: 2,
    hostBindings: function Row_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵattribute("alignment", ctx.alignment())("distribution", ctx.distribution());
      }
    },
    inputs: {
    ...
    template: function Row_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵelementStart(0, "section");
        ɵɵrepeaterCreate(1, Row_For_2_Template, 1, 2, "ng-container", 0, ɵɵrepeaterTrackByIdentity);
        ɵɵelementEnd();
      }
      if (rf & 2) {
        ɵɵstyleMap(ctx.theme.additionalStyles == null ? null : ctx.theme.additionalStyles.Row);
        ɵɵclassMap(ctx.classes());
        ɵɵadvance();
        ɵɵrepeater(ctx.component().properties.children);
      }
    },
    dependencies: [Renderer2],
    styles: ["[_nghost-%COMP%]{display:flex;flex:var(--weight)}section[_ngcontent-%COMP%]{display:flex;flex-direction:row;width:100%;min-height:100%;box-sizing:border-box}.align-start[_ngcontent-%COMP%]{align-items:start}.align-center[_ngcontent-%COMP%]{align-items:center}.align-end[_ngcontent-%COMP%]{align-items:end}.align-stretch[_ngcontent-%COMP%]{align-items:stretch}.distribute-start[_ngcontent-%COMP%]{justify-content:start}.distribute-center[_ngcontent-%COMP%]{justify-content:center}.distribute-end[_ngcontent-%COMP%]{justify-content:end}.distribute-spaceBetween[_ngcontent-%COMP%]{justify-content:space-between}.distribute-spaceAround[_ngcontent-%COMP%]{justify-content:space-around}.distribute-spaceEvenly[_ngcontent-%COMP%]{justify-content:space-evenly}"]
  });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Row, [{
    type: Component,
    args: [{
      selector: "a2ui-row",
      imports: [Renderer2],
...
var Column = class _Column extends DynamicComponent {
  alignment = input("stretch", ...ngDevMode ? [{
    debugName: "alignment"
  }] : []);
  distribution = input("start", ...ngDevMode ? [{
  ...
  classes = computed(() => __spreadProps(__spreadValues({}, this.theme.components.Column), {
    [`align-${this.alignment()}`]: true,
    [`distribute-${this.distribution()}`]: true
  }), ...ngDevMode ? [{
    debugName: "classes"
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    let ɵColumn_BaseFactory;
    return function Column_Factory(__ngFactoryType__) {
      return (ɵColumn_BaseFactory || (ɵColumn_BaseFactory = ɵɵgetInheritedFactory(_Column)))(__ngFactoryType__ || _Column);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    type: _Column,
    selectors: [["a2ui-column"]],
    inputs: {
      alignment: [1, "alignment"],
      distribution: [1, "distribution"]
    },
    ...
    vars: 4,
    consts: [["a2ui-renderer", "", 3, "surfaceId", "component"]],
    template: function Column_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵelementStart(0, "section");
        ɵɵrepeaterCreate(1, Column_For_2_Template, 1, 2, "ng-container", 0, ɵɵrepeaterTrackByIdentity);
        ɵɵelementEnd();
      }
      if (rf & 2) {
        ɵɵstyleMap(ctx.theme.additionalStyles == null ? null : ctx.theme.additionalStyles.Column);
        ɵɵclassMap(ctx.classes());
        ɵɵadvance();
        ɵɵrepeater(ctx.component().properties.children);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Column, [{
    type: Component,
    args: [{
...
var MarkdownRenderer = class _MarkdownRenderer {
  ...
  static ɵfac = function MarkdownRenderer_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MarkdownRenderer)();
  };
  static ɵprov = ɵɵdefineInjectable({
    token: _MarkdownRenderer,
    factory: _MarkdownRenderer.ɵfac,
    providedIn: "root"
  });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MarkdownRenderer, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
var Text = class _Text extends DynamicComponent {
  ...
  resolvedText = computed(() => {
    ...
    return this.markdownRenderer.render(value, styles_exports.appendToAll(this.theme.markdown, ["ol", "ul", "li"], {}));
  }, ...ngDevMode ? [{
    debugName: "resolvedText"
  }] : []);
  classes = computed(() => {
    const usageHint = this.usageHint();
    return styles_exports.merge(this.theme.components.Text.all, usageHint ? this.theme.components.Text[usageHint] : {});
  }, ...ngDevMode ? [{
    debugName: "classes"
  }] : []);
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    let ɵText_BaseFactory;
    return function Text_Factory(__ngFactoryType__) {
      return (ɵText_BaseFactory || (ɵText_BaseFactory = ɵɵgetInheritedFactory(_Text)))(__ngFactoryType__ || _Text);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    type: _Text,
    ...
    vars: 5,
    consts: [[3, "innerHTML"]],
    template: function Text_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵdomElement(0, "section", 0);
      }
      if (rf & 2) {
        ɵɵstyleMap(ctx.additionalStyles());
        ɵɵclassMap(ctx.classes());
        ɵɵdomProperty("innerHTML", ctx.resolvedText(), ɵɵsanitizeHtml);
      }
    },
    styles: ["a2ui-text{display:block;flex:var(--weight)}a2ui-text h1,a2ui-text h2,a2ui-text h3,a2ui-text h4,a2ui-text h5{line-height:inherit;font:inherit}\n"],
    encapsulation: 2
  });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Text, [{
    type: Component,
    args: [{
      selector: "a2ui-text",
      template: `
...
var DEFAULT_CATALOG = {
  Row: {
    ...
    bindings: (node) => {
      ...
      return [inputBinding("alignment", () => properties.alignment ?? "stretch"), inputBinding("distribution", () => properties.distribution ?? "start")];
    }
  },
  Column: {
    type: () => Column,
  ...
  List: {
    type: () => import("./a2ui-angular-list-nEeT59V3-WQOMJRKJ.js").then((r) => r.List),
    bindings: (node) => {
      const properties = node.properties;
      return [inputBinding("direction", () => properties.direction ?? "vertical")];
    }
  },
  Card: () => import("./a2ui-angular-card-Ix6OIdUv-MB7MP32P.js").then((r) => r.Card),
  Image: {
    type: () => import("./a2ui-angular-image-BWzAw0rh-SSUMNZRM.js").then((r) => r.Image),
    bindings: (node) => {
      const properties = node.properties;
      return [inputBinding("url", () => properties.url), inputBinding("usageHint", () => properties.usageHint)];
    }
  },
  Icon: {
    type: () => import("./a2ui-angular-icon-BE9Hj9V6-PNGYIVKH.js").then((r) => r.Icon),
    bindings: (node) => {
      const properties = node.properties;
  ...
  Video: {
    type: () => import("./a2ui-angular-video-DuFTfN0B-UASMGDMW.js").then((r) => r.Video),
    bindings: (node) => {
      const properties = node.properties;
  ...
  AudioPlayer: {
    type: () => import("./a2ui-angular-audio-DoZb9mn_-BFQ54Q6Z.js").then((r) => r.Audio),
    bindings: (node) => {
      const properties = node.properties;
      return [inputBinding("url", () => properties.url)];
    }
  ...
  Text: {
    ...
    bindings: (node) => {
      const properties = node.properties;
      return [inputBinding("text", () => properties.text), inputBinding("usageHint", () => properties.usageHint || null)];
    }
  },
  Button: {
    type: () => import("./a2ui-angular-button-CvH0kAtN-RC4VWMRO.js").then((r) => r.Button),
    bindings: (node) => {
      const properties = node.properties;
      return [inputBinding("action", () => properties.action)];
    }
  },
  Divider: () => import("./a2ui-angular-divider-BizPl3qL-TJG5ROYF.js").then((r) => r.Divider),
  MultipleChoice: {
    type: () => import("./a2ui-angular-multiple-choice-Bry7X74i-YY6I6NPB.js").then((r) => r.MultipleChoice),
    bindings: (node) => {
      const properties = node.properties;
      return [
        ...
        // TODO: this should be defined in the properties
      ];
    }
  },
  TextField: {
    type: () => import("./a2ui-angular-text-field-Deokh07j-FAOACITZ.js").then((r) => r.TextField),
    bindings: (node) => {
      const properties = node.properties;
      return [inputBinding("text", () => properties.text ?? null), inputBinding("label", () => properties.label), inputBinding("inputType", () => properties.type)];
    }
  },
  DateTimeInput: {
    type: () => import("./a2ui-angular-datetime-input-dmZAjvrF-ZJGYSO5N.js").then((r) => r.DatetimeInput),
    bindings: (node) => {
      const properties = node.properties;
      return [inputBinding("enableDate", () => properties.enableDate), inputBinding("enableTime", () => properties.enableTime), inputBinding("value", () => properties.value)];
    }
  },
  CheckBox: {
    type: () => import("./a2ui-angular-checkbox-BN4EF2Ci-HLFF6F2T.js").then((r) => r.Checkbox),
    bindings: (node) => {
      const properties = node.properties;
      return [inputBinding("label", () => properties.label), inputBinding("value", () => properties.value)];
    }
  },
  Slider: {
    type: () => import("./a2ui-angular-slider-BgseUbN2-NDZYHO46.js").then((r) => r.Slider),
    bindings: (node) => {
      const properties = node.properties;
      return [
  ...
  Tabs: {
    type: () => import("./a2ui-angular-tabs-q5Mn9vgq-YO4MHZHM.js").then((r) => r.Tabs),
    bindings: (node) => {
      const properties = node.properties;
  ...
  Modal: {
    type: () => import("./a2ui-angular-modal-mr9LmczA-XFJVLL4R.js").then((r) => r.Modal),
    bindings: () => []
  }
};
var Surface = class _Surface {
  ...
  surface = input.required(...ngDevMode ? [{
    debugName: "surface"
  }] : []);
  styles = computed(() => {
  ...
  static ɵfac = function Surface_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Surface)();
  };
  static ɵcmp = ɵɵdefineComponent({
    type: _Surface,
    selectors: [["a2ui-surface"]],
    hostVars: 2,
    hostBindings: function Surface_HostBindings(rf, ctx) {
      if (rf & 2) {
    ...
    vars: 3,
    consts: [["a2ui-renderer", "", 3, "surfaceId", "component"]],
    template: function Surface_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵdeclareLet(0)(1);
        ɵɵconditionalCreate(2, Surface_Conditional_2_Template, 1, 2, "ng-container", 0);
      }
      if (rf & 2) {
        const surfaceId_r3 = ɵɵstoreLet(ctx.surfaceId());
        ɵɵadvance();
        const surface_r4 = ɵɵstoreLet(ctx.surface());
        ɵɵadvance();
        ɵɵconditional(surfaceId_r3 && surface_r4 ? 2 : -1);
      }
    },
    dependencies: [Renderer2],
    styles: ["[_nghost-%COMP%]{display:flex;min-height:0;max-height:100%;flex-direction:column;gap:16px}"]
  });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Surface, [{
    type: Component,
    args: [{
...
//# sourceMappingURL=chunk-LE62UOP7.js.map
