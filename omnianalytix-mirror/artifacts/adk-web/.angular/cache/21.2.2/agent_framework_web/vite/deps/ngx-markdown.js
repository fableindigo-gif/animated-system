      ...
      if (n.hooks) {
        ...
        for (let s in n.hooks) {
          ...
          P.passThroughHooks.has(s) ? i[a] = (p) => {
            if (this.defaults.async && P.passThroughHooksRespectAsync.has(s)) return (() => __async(this, null, function* () {
            ...
            if (this.defaults.async) return (() => __async(this, null, function* () {
              ...
              return d === false && (d = yield u.apply(i, p)), d;
            }))();
            let c = o.apply(i, p);
            return c === false && (c = u.apply(i, p)), c;
          };
  ...
  parseMarkdown(e) {
    return (n, r) => {
      ...
      if (s.hooks && (s.hooks.options = s, s.hooks.block = e), s.async) return (() => __async(this, null, function* () {
        let o = s.hooks ? yield s.hooks.preprocess(n) : n, p = yield (s.hooks ? yield s.hooks.provideLexer(e) : e ? x.lex : x.lexInline)(o, s), c = s.hooks ? yield s.hooks.processAllTokens(p) : p;
        s.walkTokens && (yield Promise.all(this.walkTokens(c, s.walkTokens)));
        let h = yield (s.hooks ? yield s.hooks.provideParser(e) : e ? b.parse : b.parseInline)(c, s);
